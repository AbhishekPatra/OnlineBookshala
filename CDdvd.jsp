...
<!-- ******** END ALLWEBMENUS CODE FOR xptabs ******** -->
       ...
       <center><font face="Times new Roman" size="7" color="Orange">ONLINE BOOKSHALA</font></center>
        ...
        <center>
            ...
            String st[] = c.infor("SAMSUNG");
                     
                 %>
        <table cellspacing="20">
    <tr>
        <td>
            <IMG SRC="pic/cd/cd3.jpg" BORDER="1"  HEIGHT="180" WIDTH="150"></IMG>
       ...
       <td align="left"><br><br>
        ...
        <td>
            <IMG SRC="pic/cd/cd1.jpg" BORDER="1"  HEIGHT="180" WIDTH="150"></IMG> 
        </td>
         ...
         <td align="left"><br><br>
            ...
            <tr>
        <td>
            <IMG SRC="pic/cd/cd2.jpg" BORDER="1"  HEIGHT="180" WIDTH="150"></IMG> 
        </td>
        ...
        <td>
            <IMG SRC="pic/cd/cd4.jpg" BORDER="1"  HEIGHT="180" WIDTH="150"></IMG> 
        </td>
        ...
        <tr>
        <td>
            <IMG SRC="pic/cd/cd5.jpg" BORDER="1"  HEIGHT="180" WIDTH="150"></IMG> 
        </td>
